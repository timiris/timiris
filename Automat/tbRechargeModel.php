...
class Recharge {
	static function Ajouter(){
		global $connection, $tbAllTables, $valFacial;
		...
		(
		  ...
		  autre_j1 integer DEFAULT 0,
		  autre_j2 integer DEFAULT 0,
		  autre_j3 integer DEFAULT 0,
		  autre_j4 integer DEFAULT 0,
		  autre_j5 integer DEFAULT 0,
		  autre_j6 integer DEFAULT 0,
		  autre_j7 integer DEFAULT 0,
		  autre_j8 integer DEFAULT 0,
		  autre_j9 integer DEFAULT 0,
		  autre_j10 integer DEFAULT 0,
		  autre_j11 integer DEFAULT 0,
		  autre_j12 integer DEFAULT 0,
		  autre_j13 integer DEFAULT 0,
		  autre_j14 integer DEFAULT 0,
		  autre_j15 integer DEFAULT 0,
		  autre_j16 integer DEFAULT 0,
		  autre_j17 integer DEFAULT 0,
		  autre_j18 integer DEFAULT 0,
		  autre_j19 integer DEFAULT 0,
		  autre_j20 integer DEFAULT 0,
		  autre_j21 integer DEFAULT 0,
		  autre_j22 integer DEFAULT 0,
		  autre_j23 integer DEFAULT 0,
		  autre_j24 integer DEFAULT 0,
		  autre_j25 integer DEFAULT 0,
		  autre_j26 integer DEFAULT 0,
		  autre_j27 integer DEFAULT 0,
		  autre_j28 integer DEFAULT 0,
		  autre_j29 integer DEFAULT 0,
		  autre_j30 integer DEFAULT 0,
		  autre_j31 integer DEFAULT 0,
		  autre_j32 integer DEFAULT 0,
		  autre_m1 integer DEFAULT 0,
		  autre_m2 integer DEFAULT 0,
		  autre_m3 integer DEFAULT 0,
		  autre_m4 integer DEFAULT 0,
		  autre_m5 integer DEFAULT 0,
		  autre_m6 integer DEFAULT 0,
		  autre_m7 integer DEFAULT 0,
		  autre_m8 integer DEFAULT 0,
		  autre_m9 integer DEFAULT 0,
		  autre_m10 integer DEFAULT 0,
		  autre_m11 integer DEFAULT 0,
		  autre_m12 integer DEFAULT 0,
		  autre_m13 integer DEFAULT 0,
		  autre_a1 bigint DEFAULT 0,
		  autre_a2 bigint DEFAULT 0,
		  autre_a3 bigint DEFAULT 0,
		  autre_a4 bigint DEFAULT 0,
		  autre_a5 bigint DEFAULT 0,
		...
		$tbAllTables[] = 'data_recharge_'.$valFacial;
	}
}
?>