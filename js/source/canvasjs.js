/**
* @preserve CanvasJS HTML5 & JavaScript Charts - v1.8.0 GA - http://business-telecom.com/ 
...
(function () {
	...
	Chart.prototype._updateOptions = function () {
		...
		if (typeof (defaultOptions.Chart.creditHref) === "undefined") {
			this.creditHref = "http://business-telecom.com/";
			this.creditText = "TIMIRIS";
		} else {
